...
public class DataAdapter extends BaseAdapter {
	...
	ViewHolder holder;
	ImageLoader imgload;
	public DataAdapter(Context baseContext, ArrayList<UserData> userArray2) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null)
		{
			vi = inflater.inflate(R.layout.single_listview, null);
			holder = new ViewHolder();

			holder.bbmPinView = (TextView)vi.findViewById(R.id.bbm_pin);
			holder.bbmUserView = (TextView)vi.findViewById(R.id.bbmuser_name);
			holder.bbmUserImage = (ImageView)vi.findViewById(R.id.bbm_user_img);
